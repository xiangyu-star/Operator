...
- RNA: n=5, statuses=methylation_non_leaking_gene_linked_RNA_nearest_TSS
...
- RNA_ridge_beta_diagnostic: occupancy=1.000, cosine=1.000, PC3_recovery=0.996, status=uses_morula_methylation_residual_for_beta
...
- RNA_unit_beta: occupancy=0.200, cosine=0.448, PC3_recovery=0.088, status=external_feature_defined
- combined_external_unit_beta: occupancy=0.200, cosine=0.448, PC3_recovery=0.088, status=external_feature_defined
- all_available_unit_beta: occupancy=0.200, cosine=0.448, PC3_recovery=0.088, status=includes_internal_proxy_features
- methylation_only_strict_baseline: occupancy=0.044, cosine=nan, PC3_recovery=-0.000, status=baseline
- RNA_unit_beta_sign_flip: occupancy=0.000, cosine=-0.448, PC3_recovery=-0.088, status=sign_flip_control
- combined_external_unit_beta_sign_flip: occupancy=0.000, cosine=-0.448, PC3_recovery=-0.088, status=sign_flip_control
